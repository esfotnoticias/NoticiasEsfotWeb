...
@Component({
  selector: 'app-even-admin-modify',
  templateUrl: './even-admin-modify.component.html',
  styleUrls: ['./even-admin-modify.component.css']
})
export class EvenAdminModifyComponent implements OnInit {
