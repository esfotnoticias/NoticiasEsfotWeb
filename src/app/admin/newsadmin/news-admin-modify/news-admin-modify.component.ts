...
@Component({
  selector: 'app-news-admin-modify',
  templateUrl: './news-admin-modify.component.html',
  styleUrls: ['./news-admin-modify.component.css']
})
export class NewsAdminModifyComponent implements OnInit {
