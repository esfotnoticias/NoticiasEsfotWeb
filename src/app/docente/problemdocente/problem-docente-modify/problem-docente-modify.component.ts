...
@Component({
  selector: 'app-problem-docente-modify',
  templateUrl: './problem-docente-modify.component.html',
  styleUrls: ['./problem-docente-modify.component.css']
})
export class ProblemDocenteModifyComponent implements OnInit {
