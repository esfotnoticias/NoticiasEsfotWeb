...
@Component({
  selector: 'app-news-secre-modify',
  templateUrl: './news-secre-modify.component.html',
  styleUrls: ['./news-secre-modify.component.css']
})
export class NewsSecreModifyComponent implements OnInit {
