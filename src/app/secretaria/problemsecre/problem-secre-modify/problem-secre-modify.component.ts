...
@Component({
  selector: 'app-problem-secre-modify',
  templateUrl: './problem-secre-modify.component.html',
  styleUrls: ['./problem-secre-modify.component.css']
})
export class ProblemSecreModifyComponent implements OnInit {
