...
@Component({
  selector: 'app-event-secre-modify',
  templateUrl: './event-secre-modify.component.html',
  styleUrls: ['./event-secre-modify.component.css']
})
export class EventSecreModifyComponent implements OnInit {
